...
EngineZ::SpriteMovementAnimationComponent::SpriteMovementAnimationComponent(GameObject* gameObject)
...
void EngineZ::SpriteMovementAnimationComponent::Initialize(const std::string& textureMapName, float newFramerate)
{
...
void EngineZ::SpriteMovementAnimationComponent::Update(float deltaTime)
{
...
void EngineZ::SpriteMovementAnimationComponent::Render()
{
}
