...
void EngineZ::AudioComponent::SetLoop(bool loop) { sound->setLoop(loop); }
...
void EngineZ::AudioComponent::Stop() { sound->stop(); }

void EngineZ::AudioComponent::Pause() { sound->pause(); }
